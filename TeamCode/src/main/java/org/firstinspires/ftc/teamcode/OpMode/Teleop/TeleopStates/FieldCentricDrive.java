...
public class FieldCentricDrive extends ATeleopState {
  ...
  public void receiveMecanumDriveTrain(MecanumDriveTrain driveTrain) {
    driveTrain.setMotorPower(
        this.fieldCentricDrive(gp1.left_stick_y, gp1.left_stick_x, gp1.right_stick_x,
            this.curHeading));
  ...
  private List<Pair<DTMotorPos, Double>> fieldCentricDrive(double lStickY, double lStickX,
      double rStickX, double curHeading) {
