...
public class CalibrateGyro {
   ...
   * NOTE: Above is why there was null pointer problem in tuesday's code
   *
   *
  ...
  public BNO055IMU initGyro(HardwareMap hwMap, String configName) {
    ...
    //TODO: ONLY INITIALIZE IF NOT READING FROM FILE
    gyro.initialize(parameters);
  //gyro.writeCalibrationData(parameters.);
    return gyro;
  }
  ...
  public void initLoopGyro(BNO055IMU gyro, Telemetry telemetry) {
    ...
    // output if the file write is complete
